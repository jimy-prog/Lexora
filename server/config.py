...
OWNER_EMAIL = os.getenv("OWNER_EMAIL", "owner@lexora.local")
OWNER_FULL_NAME = os.getenv("OWNER_FULL_NAME", "Lexora Owner")
...
if _db_env:
    ...
    lexora_db = DATA_DIR / DEFAULT_DB_FILENAME
...
PASSWORD_FILE = DATA_DIR / "lexora_auth_password.txt"
